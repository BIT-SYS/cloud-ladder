...
public class CLIRCall extends CLIR {
    ...
    public void execute(CLRtFrame frame) throws CLRuntimeError {
        ...
        if (function instanceof CLBuiltinFunction) {
            newFrame = new CLRtFrame(frame.vm, frame, null, "builtin function");
        } else if (function instanceof CLUserFunction uf) {
            newFrame = new CLRtFrame(frame.vm, frame, uf.codeObject, "user function");
